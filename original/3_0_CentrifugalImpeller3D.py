...
__objs__.append(FreeCAD.getDocument("Unnamed").getObject("Meridional"))
__objs__.append(FreeCAD.getDocument("Unnamed").getObject("ModelOfBlade3D"))
Part.export(__objs__,u"C:/Users/Grant/Desktop/Cpstn/modeling/impeller.iges")
