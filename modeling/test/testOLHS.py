...
for iteration in sampleList:
    print("Experiment #"+str(sampleList.index(iteration)+1))
    print("Binding value for experiment #"+str(sampleList.index(iteration)+1))
    for i in range(ndv):
        DVGroupList[i].bindValue(iteration[i])  
    ...
    if Bla.FullDomainCFD == False and Bla.PeriodicDomainCFD == False:
        ...
        Part.export(__objs__,path_gui+u"/impeller"+str(sampleList.index(iteration)+1)+".step")
        del __objs__
    else:
        __objs__=[]
